...
void Scene::CornellSetup(){
	...
	this->t_vertices = {
		...
		//big box
		vec3(-0.0f, -2.99999f, -7.0f), //20
		vec3(-0.0f, -2.99999f, -5.0f), //21
		vec3(-2.0f, -2.99999f, -7.0f),//22
		vec3(-2.0f, -2.99999f, -5.0f),//23
		...
		//small box
		vec3(1.0f, -2.99999f, -5.0f), //28
		vec3(1.5f, -2.99999f, -4.5f), //29
		vec3(2.0f, -2.99999f, -5.0f),//30
		vec3(1.5f, -2.99999f, -5.5f),//31
